  ...
  return (
    <div className='navbar'>
      ...
      <ul ref={menuRef} className="nav-menu">
        ...
        <li > <AnchorLink className='anchor-link' offset={50} href='#mywork'><p onClick={()=>setMenu('mywork')}>Portfolio</p></AnchorLink> {menu==='mywork' ? <img src={underline}/> : <></>}</li>
